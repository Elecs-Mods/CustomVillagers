...
import elec332.customvillagers.event.VillageTradeHandler;
...
public class CustomVillagerRegistry {
    ...
    private CustomVillagerRegistry(){
        ...
        files = Lists.newArrayList("Villagers.json", AUTOGENERATED);
        registeredIDs = Lists.newArrayList(cpw.mods.fml.common.registry.VillagerRegistry.getRegisteredVillagers());
    }

    private static final String AUTOGENERATED = "AutoGenerated.json";
    ...
    public VillagerData getData(int i){
        if (isVillagerRegistered(i)) {
            ...
            throw new RuntimeException("Something went wrong while trying to acquire VillagerData for villager: "+i);
        } else {
            VillagerData data = new VillagerData();
            data.ID = i;
            registerData(AUTOGENERATED, data);
            registeredIDs.add(i);
            return data;
        }
    }
